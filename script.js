...
// [신규] 고난도 퀴즈 7선 (상세 해설 및 정답 수정)
const WEEKLY_QUIZ = [
    { 
        day: 0, text: "[일요일: 수량적 추론]\n1000 미만의 자연수 중에서 3 또는 5의 배수인\n모든 수의 합은 얼마일까요?", ans: "233168", hint: "3의 배수의 합과 5의 배수의 합을 더한 뒤, 15의 배수의 합을 빼보세요.", 
        exp: "포함-배제의 원리를 이용합니다.\n1) 3의 배수 합(3~999): 166,833\n2) 5의 배수 합(5~995): 99,500\n3) 15의 배수 합(15~990): 33,165\n결과: 166,833 + 99,500 - 33,165 = 233,168입니다.", 
        src: "Project Euler #1", type: "math" 
    },
    { 
        day: 1, text: "[월요일: 논리 행렬]\n세 상자 중 하나에만 금이 있습니다. 한 명만 진실입니다.\n금: '은은 여기 없다.', 은: '금은 여기 없다.', 빈 상자: '여기는 비어있다.'\n금은 어느 상자에 있을까요?", ans: "은", hint: "은 상자의 말이 진실이라고 가정하고 나머지를 검토하세요.", 
        exp: "은 상자의 말이 진실이라면, 금과 빈 상자의 말은 거짓이어야 합니다. 이 경우 모순 없이 금이 은 상자에 위치하게 됩니다.", 
        src: "Classical Logic", type: "logic" 
    },
    { 
        day: 2, text: "[화요일: 패턴 인식]\n1, 4, 9, 61, 52, 63...\n다음에 올 숫자는 무엇일까요?", ans: "94", hint: "나열된 숫자를 각각 거꾸로 뒤집어서 읽어보세요.", 
        exp: "제곱수(1, 4, 9, 16, 25, 36)를 뒤집은 수열입니다. 다음 제곱수인 49를 뒤집으면 94가 됩니다.", 
        src: "Numerical Pattern", type: "math" 
    },
    { 
        day: 3, text: "[수요일: 상황 추리]\n바에서 물을 요청하자 바텐더가 총을 겨눴고,\n남자는 '고맙습니다'라며 나갔습니다. 이유는? (세 글자)", ans: "딸꾹질", hint: "남자가 물을 원했던 이유와 총을 보고 놀랐을 때의 효과를 연결하세요.", 
        exp: "남자는 딸꾹질을 멈추려 물을 원했습니다. 바텐더가 총으로 남자를 놀래켜 딸꾹질을 멈춰주자 감사하며 나간 것입니다.", 
        src: "Situation Quiz", type: "situation", keywords: { "총": "놀라게 하는 도구", "물": "딸꾹질 완화용" } 
    },
    { 
        day: 4, text: "[목요일: 수리 논리]\n머리카락 수가 똑같은 사람이 반드시 존재함을 증명하려면,\n최소 인구는 몇 명이어야 할까요? (최대 15만 가닥 가정)", ans: "150001", hint: "비둘기집 원리: 가능한 경우의 수보다 인구가 많아야 합니다.", 
        exp: "머리카락 수가 0~15만 가닥인 총 150,001가지 경우가 존재하므로, 그보다 1명 많은 150,001명이 필요합니다.", 
        src: "Discrete Math", type: "math" 
    },
    { 
        day: 5, text: "[금요일: 공간 지각]\n30m 우물을 달팽이가 낮에 3m 오르고, 밤에 2m 미끄러집니다.\n꼭대기에 도달하는 데 걸리는 일수는?", ans: "28", hint: "마지막 날 꼭대기에 닿으면 더 이상 밤에 미끄러지지 않습니다.", 
        exp: "27일 낮에 27m에 도달하고 밤에 미끄러지면 25m입니다. 28일 낮에 3m를 올라 30m가 되어 탈출합니다.", 
        src: "Classic Puzzle", type: "spatial" 
    },
    { 
        day: 6, text: "[토요일: 제약 충족]\n정육면체의 면을 칠할 때 인접한 면의 색이 달라야 합니다.\n필요한 최소 색깔의 수는?", ans: "3", hint: "마주 보는 면끼리는 서로 닿지 않으므로 같은 색을 칠할 수 있습니다.", 
        exp: "위-아래, 앞-뒤, 좌-우 세 쌍의 마주 보는 면에 각각 다른 색을 칠하면 최소 3색으로 가능합니다.", 
        src: "Geometry Logic", type: "logic" 
    }
];
...
function processEnd(quiz, isWin) {
    ...
    document.getElementById('share-btn').onclick = () => {
        ...
        const shareText = `[시냅스 스파크] ⚡${streak}\n\n${attemptVisual} (${time})\n\n함께해요! : https://koreanboar.github.io/Synapse-Spark/`;
