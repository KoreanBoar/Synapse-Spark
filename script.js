...
const WEEKLY_QUIZ = [
    ...
    { 
        ...
        ans: "은", 
        hint: "각 설명이 진실일 경우를 하나씩 가정하여 모순을 찾아보세요.", 
        exp: "은 상자의 말이 진실이라면, 금과 빈 상자의 말은 거짓이 되어야 합니다. 이 경우 모순 없이 금이 은 상자에 위치하게 됩니다.", 
    ...
    { 
        ...
        text: "[화요일: 패턴 인식]\n1, 4, 9, 61, 52, 63...\n다음에 올 숫자는 무엇일까요?", 
        ans: "94", 
        hint: "나열된 숫자를 각각 거꾸로 뒤집어서 읽어보세요.", 
        exp: "제곱수(1, 4, 9, 16, 25, 36)를 뒤집은 수열입니다. 다음 제곱수인 49를 뒤집으면 94가 됩니다.", 
        src: "Numerical Pattern", type: "math" 
    },
    { 
        day: 3, 
        text: "[수요일: 상황 추리]\n바에서 물을 요청하자 바텐더가 총을 겨눴고,\n남자는 '고맙습니다'라며 나갔습니다. 이유는? (세 글자)", 
        ans: "딸꾹질", 
        hint: "남자가 물을 찾은 초기 목적과 바텐더가 남자를 놀라게 한 이유를 생각하세요.", 
        exp: "남자는 딸꾹질을 멈추려 물을 찾았습니다. 바텐더가 총으로 남자를 놀라게 해 딸꾹질을 멈춰주자 감사 인사를 하고 나간 것입니다.", 
        src: "Situation Quiz", type: "situation", keywords: { "총": "놀라게 하는 도구", "물": "딸꾹질 완화용" } 
    },
    { 
        day: 4, 
        text: "[목요일: 수리 논리]\n머리카락 수가 똑같은 사람이 반드시 존재함을 증명하려면,\n최소 인구는 몇 명이어야 할까요? (최대 15만 가닥 가정)", 
        ans: "150001", 
        hint: "비둘기집 원리: 상자보다 물건이 하나 더 많아야 중복이 생깁니다.", 
        exp: "머리카락 수가 0~15만 가닥인 총 150,001가지 경우가 존재하므로, 그보다 1명 많은 150,001명이 모여야 합니다.", 
    ...
    { 
        ...
        ans: "28", 
        hint: "마지막 날 꼭대기에 닿으면 더 이상 밤에 미끄러지지 않습니다.", 
        exp: "27일 낮에 27m에 도달하고 밤에 미끄러지면 25m입니다. 28일 낮에 3m를 올라 30m가 되어 탈출에 성공합니다.", 
    ...
    { 
        ...
        ans: "3", 
        hint: "마주 보는 면끼리는 서로 닿지 않으므로 같은 색을 칠할 수 있습니다.", 
